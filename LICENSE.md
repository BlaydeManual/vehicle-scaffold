...
This repository has two different kinds of content under two different licenses.

## Code and structure (`manifest.json`, scripts, workflows)

GNU Affero General Public License v3.0 (AGPL-3.0). Copyright the Blayde
Manual project.
...
in the main tooling repo for the
full reasoning, including why this was chosen over a more permissive
license like MIT.

Full text: see `LICENSE` in this repo's own root.
...
rendered on the photo in any generated PDF).

This project does not hold copyright over contributed photos and cannot
grant rights beyond what CC-BY 4.0 already provides. If you have a
question about using a specific photo, the contributor who took it is the
one to ask.
