...
- [ ] Filename follows the convention: `<procedure_id>__by_<my-github-username>.jpg`
      (or add `__altN` if this is an alternate angle, not a replacement)

## Notes for the reviewer (optional)

<!-- Anything about lighting, angle, why you think this documents the step
     well, or where in your restoration/repair this was taken. -->
